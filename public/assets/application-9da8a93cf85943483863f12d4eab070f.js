...
(function() {
  ...
  jQuery(function() {
    ...
    uploaderHost = "https://s3.amazonaws.com";
      ...
      switch (eventType) {
        ...
        case 'add upload':
          if (progressSupported) {
            ...
            $('#uploading_files').append("<p class='uploading_file'>" + data.file_name + "<br/><img src='/assets/uploading-bc2173333512e8b9accb1f992e28d8e2.gif'/></p>");
          }
